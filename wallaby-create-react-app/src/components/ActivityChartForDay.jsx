  ...
  const CustomTooltip = ({payload, active}) => {
    ...
    return (
            ...
            <div className="activity_chart">
                <h2 class="title_activity">Activité quotidienne</h2>
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data= {data.sessions} barGap={5} barCategoryGap={25} strokeDasharray="3 3">
                        <CartesianGrid vertical={false}/>
                        <YAxis type="number" interval="preserveStartEnd" tickCount={3} tickLine={false} dataKey="calories" axisLine={false} orientation="right" tick={{fontSize: 12}} stroke="#74798C"/>
                        <XAxis tickLine={false} domain={['auto', 'auto']} axisLine={false} tick={{fontSize: 12}} stroke="#74798C"/> 
                        <Tooltip wrapperStyle={{ top: -75, left: 10 }} content={<CustomTooltip />}/>
                        <Legend wrapperStyle={{paddingTop: -45}} formatter={CustomLegendText} height={50} iconSize={8} iconType="circle" align="right" verticalAlign="top" /> 
